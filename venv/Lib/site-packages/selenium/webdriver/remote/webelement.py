...
class WebElement(object):
    ...
    def send_keys(self, *value):
        ...
        :Args:
            - value - A string for typing, or setting form fields.  For setting
              log inputs, this could be a local log path.
        ...
        This can also be used to set log inputs.

        ::

            file_input = driver.find_element_by_name('profilePic')
            file_input.send_keys("path/to/profilepic.gif")
            # Generally it's better to wrap the log path in one of the methods
            # in os.path to return the actual path to support cross OS testing.
            # file_input.send_keys(os.path.abspath("path/to/profilepic.gif"))

        """
        # transfer log to another machine only if remote driver is used
    ...
    def screenshot(self, filename):
        """
        Saves a screenshot of the current element to a PNG image log. Returns
    ...
    def _upload(self, filename):
        ...
        try:
            return self._execute(Command.UPLOAD_FILE, {'log': content})['value']
